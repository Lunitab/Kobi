...
<body>
            ...
            <div class="main-form">
                ...
                <form action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <label for="nombrePrecio" class="nombrePrecio">
                        <input type="text" name="nombre" class="nombre-input input" placeholder="Nombre del alimento" required />

                        <input type="number" name="precio" placeholder="Precio" class="precio-input input" required />
                    </label>

                    <label for="desc" class="desc">
                        <textarea name="desc" class="desc-input input" placeholder="Descripcion del alimento" required></textarea>
    ...
    if (
        ...
        $insertar = "INSERT INTO alimentos (nombre, precio, imagen, descripcion, estatus, menu_id) VALUES ('$nombre','$precio', '$imgURL', '$desc', '$estatus', '$menuId')";

        $resultado = mysqli_query($con, $insertar);

        if ($resultado) {

            $idAlimento = mysqli_query($con, "SELECT id FROM alimentos WHERE nombre = '$nombre' and descripcion = '$desc';")->fetch_object()->id;

            $registrarEtiqueta = "INSERT INTO alimentos_etiquetas (alimento_id, etiqueta_id) VALUES ('$idAlimento', '$etiqueta')";
